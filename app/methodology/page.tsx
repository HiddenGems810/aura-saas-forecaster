        ...
        <article>
          ...
          <div className="mt-10 space-y-10 text-base leading-8 text-slate-300">
            ...
            <section>
              ...
              <p className="mt-4">You can also use the <Link className="text-teal-300 hover:text-teal-200" href="/tools">SaaS calculator toolkit</Link> for single-metric calculations such as <Link className="text-teal-300 hover:text-teal-200" href="/tools/arr-run-rate-calculator">ARR run rate</Link>, <Link className="text-teal-300 hover:text-teal-200" href="/tools/saas-churn-calculator">churn</Link>, <Link className="text-teal-300 hover:text-teal-200" href="/tools/net-revenue-retention-calculator">NRR</Link>, and <Link className="text-teal-300 hover:text-teal-200" href="/tools/saas-burn-multiple-calculator">burn multiple</Link>.</p>
            </section>
            <section>
